...
// Cek jika ada input yang dikirim melalui form
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query SQL untuk memasukkan data ke dalam tabel iklim
    $sql = "INSERT INTO iklim (nama_daerah, cuaca, suhu, kelembaban_udara) 
            VALUES ('$nama_daerah', '$cuaca', '$suhu', '$kelembaban_udara')";

    // Eksekusi query
    if ($conn->query($sql) === TRUE) {
        // Jika data berhasil ditambahkan, arahkan ke halaman admin_dashboard.php
...
<html lang="en">
    <head>
        ...
        <title>Tambah Data Perkiraan Cuaca</title>
                        ...
                        <div class="page-title-box">
                            <div class="btn-group float-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Form Tambah Data Perkiraan Cuaca</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Data Perkiraan Cuaca</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Tambah Data Perkiraan Cuaca</h4>
                                        ...
                                        <div class="p-20">
                                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="kelembaban_udara" name="kelembaban_udara">
                                                </div>

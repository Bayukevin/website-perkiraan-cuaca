...
if ($result === false) {
    ...
    if ($result->num_rows > 0) {
        ...
        $nama = $row['nama'];
        $email = $row['email'];
        // Tidak menampilkan password asli di sini
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlUpdate = "UPDATE users SET nama='$newNama', email='$newEmail', password='$hashedPassword' WHERE username='$username'";

    if ($conn->query($sqlUpdate) === TRUE) {
        echo "Data berhasil diperbarui.";
        // Refresh data yang ditampilkan pada halaman profil setelah perubahan
        $nama = $newNama;
        $email = $newEmail;
    } else {
                        ...
                        <div class="page-title-box">
                            <div class="btn-group float-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Form Edit Profil</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Edit Data Profil</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Edit Data Profil</h4>
                                        ...
                                        <div class="p-20">
                                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <input type="text" class="form-control" id="new_nama" name="new_nama" value="<?php echo $nama; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Email</label>

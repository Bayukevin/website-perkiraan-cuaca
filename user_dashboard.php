            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card  m-b-30 text-white weather-box" style="background-image: url(assets/images/bg.png); background-size:cover;">
                                    <div class="card-body m-t-10">
                                        <div class="text-center align-center">
                                            <div>
                                                <h1>WEATHER APP</h1>
                                                <canvas id="rain" width="150" height="150"></canvas>
                                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title mb-4">Perkiraan Cuaca</h4>
